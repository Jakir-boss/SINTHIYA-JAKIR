...
fuck/Fuck.py
@Vpn jakir
Vpn jakir Create Fuck.py
…
 1 contributor
356 lines (267 sloc)  10.6 KB
#C4A

#use with cradit👇👇👇👇👇

#T.J KING FORCE VOICE GANG 
...
|  $$$$$$/| $$  | $$| $$ \  $$ /$$$$$$| $$  | $$
 \______/ |__/  |__/|__/  \__/|______/|__/  |__/
    ...
    │ [✓] AUTHOR   : VPN JAKIR 😈        │
    │ [✓] GITHUB   : vpn jakir-09              │
    │ [✓] WHATSAPP : 01925052074       │
    │ [✓] POWER BY : \033[1;32m KING FORCE VOICE GANG  \033[1;37m           │[VPN JAKIR IS BRAND]
    └───────────────────────────────────────┘""")
class Main:
    def __init__(self):
        self.id = []
...
Blog
About
fuck/Fuck.py at main · Vpnjakir/fuck